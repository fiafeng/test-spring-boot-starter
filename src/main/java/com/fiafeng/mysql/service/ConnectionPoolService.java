...
public class ConnectionPoolService {
    ...
    public ConnectionPoolService(FiafengMysqlProperties mysqlProperties) {
    ...
    public ConnectionPoolService(DataSource dataSource, FiafengMysqlProperties mysqlProperties) {
